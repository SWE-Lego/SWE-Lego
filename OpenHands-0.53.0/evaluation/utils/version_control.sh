...
get_openhands_aci_version() {
    # get the version of the openhands_aci package, added by poetry
    OPENHANDS_ACI_VERSION=aci$(poetry run python -c "import importlib.metadata; print(importlib.metadata.version('openhands_aci'))")
}