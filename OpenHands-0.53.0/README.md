...
## Version history
2025.09.16: 在项目根目录`openhands`环境下执行`poetry add openhands-aci==0.3.2`: fix: view_range out of EOF

2025.09.26: 转换oh轨迹为xml格式参照[convert_openhands_to_lf_sft_nonfuncall](scripts/convert_openhands_to_lf_sft_nonfuncall.sh)
